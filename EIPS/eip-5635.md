...
interface IERC5635 {
    ...
    struct Record {
        ...
        // MUST support IArgeement interface.
        address argeement;
        // License expiry timestamp.
        uint64 expiryTime;
        // The royalty rate as an unsigned integer, scaled by 1e8.
        uint32 royaltyRateMantissa;
        // Storage the encode data of argeement arguments.
        // When minting a license, the licensor needs to definitively
        // fill in the license content as part of the content of the agreement document.
     ...
     * MUST revert if `licenseId` not found.
     */
    function origin(uint256 tokenId)
        external
        view
        returns (address originToken, uint256 originTokenId);
     ...
     * MUST revert if `licenseId` not found.
     */
    function argeementInputs(uint256 tokenId)
        external
        view
...
interface IArgeement {
     ...
     * MUST revert if the input data is invalid.
     */
    function contentURI(bytes calldata inputs)
        external
        view
